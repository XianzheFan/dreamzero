...
#
# Chained 8xH100 training for DreamZero RoboTwin (beat_block_hammer-rt).
...
WANDB_RUN_NAME=${WANDB_RUN_NAME:-robotwin_bimanual_beat_block_hammer_full}
OUTPUT_DIR=${OUTPUT_DIR:-/lustre/fs1/portfolios/nvr/projects/nvr_lpr_agentic/users/xianzhef/checkpoints/robotwin_bimanual_beat_block_hammer_full}
