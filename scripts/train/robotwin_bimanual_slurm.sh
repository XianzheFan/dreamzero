...
echo "[$(date)] Gripper config: close_threshold=$GRIPPER_CLOSE_THRESHOLD, dims=[$GRIPPER_ACTION_DIMS], clean_loss=$GRIPPER_CLEAN_ACTION_LOSS_WEIGHT, binary_loss=$GRIPPER_BINARY_ACTION_LOSS_WEIGHT"
...
GRIPPER_CLOSE_ACTION_LOSS_WEIGHT=${GRIPPER_CLOSE_ACTION_LOSS_WEIGHT} \
...
GRIPPER_CLEAN_CLOSE_ACTION_LOSS_WEIGHT=${GRIPPER_CLEAN_CLOSE_ACTION_LOSS_WEIGHT} \
GRIPPER_CLEAN_MAX_SIGMA=${GRIPPER_CLEAN_MAX_SIGMA} \
...
NEXT=$(sbatch --parsable --dependency=afterany:${SLURM_JOB_ID} \
    ...
    --export=ALL,TARGET_STEPS=${TARGET_STEPS},MAX_STEPS=${MAX_STEPS},BATCH_SIZE=${BATCH_SIZE},SAVE_STEPS=${SAVE_STEPS},LEARNING_RATE=${LEARNING_RATE},REPORT_TO=${REPORT_TO},WANDB_PROJECT=${WANDB_PROJECT},WANDB_RUN_NAME=${WANDB_RUN_NAME},OUTPUT_DIR=${OUTPUT_DIR},ROBOTWIN_DATA_ROOT=${ROBOTWIN_DATA_ROOT},ACTION_LOSS_WEIGHT=${ACTION_LOSS_WEIGHT},GRIPPER_ACTION_LOSS_WEIGHT=${GRIPPER_ACTION_LOSS_WEIGHT},GRIPPER_CLOSE_ACTION_LOSS_WEIGHT=${GRIPPER_CLOSE_ACTION_LOSS_WEIGHT},GRIPPER_CLOSE_THRESHOLD=${GRIPPER_CLOSE_THRESHOLD},GRIPPER_ACTION_DIMS=${GRIPPER_ACTION_DIMS},GRIPPER_CLEAN_ACTION_LOSS_WEIGHT=${GRIPPER_CLEAN_ACTION_LOSS_WEIGHT},GRIPPER_CLEAN_CLOSE_ACTION_LOSS_WEIGHT=${GRIPPER_CLEAN_CLOSE_ACTION_LOSS_WEIGHT},GRIPPER_CLEAN_MAX_SIGMA=${GRIPPER_CLEAN_MAX_SIGMA},GRIPPER_BINARY_ACTION_LOSS_WEIGHT=${GRIPPER_BINARY_ACTION_LOSS_WEIGHT},GRIPPER_BINARY_CLOSE_ACTION_LOSS_WEIGHT=${GRIPPER_BINARY_CLOSE_ACTION_LOSS_WEIGHT},GRIPPER_BINARY_LOGIT_SCALE=${GRIPPER_BINARY_LOGIT_SCALE},GRIPPER_BINARY_MAX_SIGMA=${GRIPPER_BINARY_MAX_SIGMA},ACTION_PREFIX_LOSS_WEIGHT=${ACTION_PREFIX_LOSS_WEIGHT},ACTION_PREFIX_LOSS_LEN=${ACTION_PREFIX_LOSS_LEN} \
