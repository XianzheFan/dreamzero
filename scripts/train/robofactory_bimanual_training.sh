...
ROPE_AGENT_DIM=${ROPE_AGENT_DIM:-16}
MULTI_AGENT_SHUFFLE_AGENTS=${MULTI_AGENT_SHUFFLE_AGENTS:-false}
MULTI_AGENT_SAMPLE_AGENT_POOL=${MULTI_AGENT_SAMPLE_AGENT_POOL:-false}
GLOBAL_VIDEO_DROPOUT_PROB=${GLOBAL_VIDEO_DROPOUT_PROB:-0.0}
GLOBAL_VIDEO_TIMESTEP_MODE=${GLOBAL_VIDEO_TIMESTEP_MODE:-video}
GLOBAL_VIDEO_ATTENTION_MODE=${GLOBAL_VIDEO_ATTENTION_MODE:-read_only}
