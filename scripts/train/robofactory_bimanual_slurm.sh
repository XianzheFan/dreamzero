...
NEXT=$(sbatch --parsable --dependency=afterany:${SLURM_JOB_ID} \
    ...
    --export=ALL,TARGET_STEPS=${TARGET_STEPS},MAX_STEPS=${MAX_STEPS},BATCH_SIZE=${BATCH_SIZE},SAVE_STEPS=${SAVE_STEPS},LEARNING_RATE=${LEARNING_RATE},REPORT_TO=${REPORT_TO},WANDB_PROJECT=${WANDB_PROJECT},WANDB_RUN_NAME=${WANDB_RUN_NAME},OUTPUT_DIR=${OUTPUT_DIR},ROBOFACTORY_DATA_ROOT=${ROBOFACTORY_DATA_ROOT},NUM_ARMS=${NUM_ARMS:-2},SHARED_GLOBAL=${SHARED_GLOBAL:-0} \
